...
public class EventStreamSubscription {
  ...
  public EventStreamSubscription(List<EventHandler> handlers, EventStore eventStore, String category) {
  ...
  private void consumeEvents() {
    ...
    do {
      val newEvents = eventStore.readFromStream("$ce-"+category, lastReadPosition + 1L);
